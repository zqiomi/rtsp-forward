#ifndef RTSP_FORWARD_RTSP_BUILDER_H_
#define RTSP_FORWARD_RTSP_BUILDER_H_
...
public:
    ...
    // 构建 SETUP 响应（UDP模式）
    std::string BuildSetupResponseUdp(int cseq, const std::string& session_id, int server_rtp_port,
...
#endif  // RTSP_FORWARD_RTSP_BUILDER_H_
